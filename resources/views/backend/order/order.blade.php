            ...
            <div class="card-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>{{$key+1}}</td>
                    <td>
                        <a href="{{route('admin.all_user.show',\App\AllUser::where('user_id',$data->user_id)->first()->id)}}">{{\App\AllUser::where('user_id',$data->user_id)->first()->name}}</a>
                    </td>
                  <td>
                    ...
                    <td>
                        @if($data->transaction_id  == null)
                            {{$package_name->monthly_charge + $package_name->device_price}}
                        @else
                    ...
                    <td>
                        ...
                        @php($assigen_technician = \App\Assign_technician_device::where('user_id',\App\AllUser::where('user_id',$data->user_id)->first()->id)->where('status',0)->where('order_id',$data->id)->get())
                    ...
                    <td>
                        ...
                        @if($assigen_technician = \App\Assign_technician_device::where('user_id',\App\AllUser::where('user_id',$data->user_id)->first()->id)->where('status',0)->where('order_id',$data->id)->exists())
                        ...
                        @php($all_user_id = \App\AllUser::where('user_id',$data->user_id)->first())
